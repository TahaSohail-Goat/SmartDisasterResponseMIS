    ...
    <div>
      ...
      <div className="stat-grid" style={{ gridTemplateColumns: 'repeat(4, 1fr)' }}>
        <div className="stat-card fade-in-up">
          ...
          <div className="stat-info">
            ...
            <div className="value" style={{ color: '#6366f1' }}>{items.length}</div>
          </div>
        </div>
                  ...
                  <tbody>
                    {filtered.map(p => (
                      <tr key={p.procurement_id}>
                        ...
                        <td style={{ fontWeight: 700, color: '#6366f1' }}>{fmtMoney(p.total_cost)}</td>
      ...
      <Modal isOpen={showCreate} onClose={() => setShowCreate(false)} title="New Procurement Request"
        ...
        {form.quantity && form.unit_cost && (
          <div style={{ padding: '10px 14px', background: 'var(--accent-subtle)', borderRadius: 'var(--radius-md)',
      ...
      <Modal isOpen={showReject} onClose={() => setShowReject(false)} title="Reject Procurement"
        ...
        <div style={{ padding: '10px 14px', background: 'var(--danger-subtle)', borderRadius: 'var(--radius-md)',
